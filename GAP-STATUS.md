# Gap status — `mycelium-lint`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-lint` |
| **Role** | myc-lint |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-lint-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Invariant + header lints |
